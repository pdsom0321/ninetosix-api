...
public enum AttendCode {
    ...
    , ATTEND_CODE_DAY_HALF_MORNING("AT02", "오전반차")
    , ATTEND_CODE_DAY_HALF_AFTERNOON("AT03","오후반차")
    , ATTEND_CODE_DAY_HALF_HALF_MORNING("AT04","오전반반차")
    , ATTEND_CODE_DAY_HALF_HALF_AFTERNOON("AT05","오후반반차")
